...
void main() {
  ...
  testWidgets('full MVP flow works', (tester) async {
    ...
    await tester.enterText(find.byKey(const Key('profile_role')), 'Founder & CEO');
    ...
    await tester.enterText(find.byKey(const Key('north_star_title')), 'Build a self-managing team');
    ...
    await tester.enterText(find.byKey(const Key('goal_title')), 'Launch sales dashboard');
